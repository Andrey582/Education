...
public class GetErrorsStringTest {
    ...
    void getErrorsString() {
        ...
        Map<String, String> result = Methods.getErrorsString(list);
    ...
    Map<String, String> expected() {
        return Map.of(
            "macaw", "weight - Incorrect bird weight\n",
            "big golden retriever", "weight - Incorrect dog weight\nheight - Incorrect dog height\n",
            "bloodhound", "weight - Incorrect dog weight\n",
            "cockatoo", "",
            "piranha", ""
        );
    }
